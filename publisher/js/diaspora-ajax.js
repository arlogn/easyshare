    ...
    retrieveToken() {
        ...
        return this.request({
            ...
            .then(response => {
                ...
                if (!match) {
                    return { error: "Fatal error, CSRF token not found." };
                }
    ...
    retrieveAspects() {
        ...
        return this.request({
            ...
            .then(response => {
                ...
                if (!match) {
                    return { error: "Something went wrong, aspects list not found." };
                }

                return { aspects: match[1] };
            })
            .catch(error => {
                return { error: error };
            });
        ...
        return this.request({
            ...
            .then(response => {
                if (response.status !== 201) {
                    return { error: "Unauthorized access. Probably incorrect or missing CSRF token." };
                }

                return { success: "Post successfully sent to your diaspora pod." };
            })
            .catch(error => {
                return { error: error };
            });
